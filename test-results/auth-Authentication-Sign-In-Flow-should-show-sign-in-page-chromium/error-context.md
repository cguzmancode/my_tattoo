...
- Name: auth.spec.ts >> Authentication >> Sign In Flow >> should show sign-in page
- Location: __tests__/e2e/auth.spec.ts:50:9
  ...
  - main [ref=e18]:
    - generic [ref=e20]:
      - generic [ref=e21]:
        ...
        - paragraph [ref=e30]: Inicia sesión para gestionar tu estudio
      - paragraph [ref=e31]:
